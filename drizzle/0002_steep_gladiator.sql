...
ALTER TABLE `product_variant_option_values` ADD CONSTRAINT `product_variant_id_fk` FOREIGN KEY (`product_variant_id`) REFERENCES `product_variants`(`id`) ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE `product_variant_option_values` ADD CONSTRAINT `product_option_value_id_fk` FOREIGN KEY (`product_option_value_id`) REFERENCES `product_option_values`(`id`) ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
